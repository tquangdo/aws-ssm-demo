...
# ~~~~~~~~~~~ 1) S3 ~~~~~~~~~~~
aws s3 rm s3://dtq-bucket-ssm/ --recursive
aws s3api delete-bucket --bucket dtq-bucket-ssm
...
# ~~~~~~~~~~~ 14) EC2 ~~~~~~~~~~~
# ~~~~~~~~~~~ list SG!!!
instance_id=$(aws ec2 describe-instances --filters "Name=tag:Name,Values=DTQWinPrivate" --query "Reservations[].Instances[].InstanceId" --output text)
